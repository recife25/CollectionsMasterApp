    ...
    class Program
    {
       ...
       //DONE --- Follow the steps provided in the comments under each region.
           ...
           Console.WriteLine("-------------------");
            ...
            //Console.WriteLine($"{numList.Sort()}");
            numList.Sort();
            NumberPrinter(numList);
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"Yes here is the number you are looking");
            }
            else
            {
                Console.WriteLine($"These are not the numbers you want");
